            ...
            <div class="userInfo">
                ...
                <table class="info-table unit-table">
                    <tr class="unit-th">
                        ...
                        <th class="info-td th">Lecturer</th>
                    ...
                    <tr>
                        ...
                        <td class="info-td td-m"><?php echo $v['lecturer'];?></td>
                        ...
                        <td class="info-td td-m">
                            <a class="delete-link" href="./deleteSession.php?id=<?php echo $v['id'];?>" onClick="return confirm('are you sure to delete?')">delete</a>
                        </td>
                    </tr>
                    <?php }?>
                </table>
                <div class="right-btn">
                    <a href="./addSession.php"><button class="btn-1 unit-btn">Add Session</button></a>
                </div>
            </div>
        </div>
