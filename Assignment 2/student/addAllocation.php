...
$sql = "select * from teach where unitName='{$unitName}'";
            ...
            <div class="userInfo">
                ...
                <table class="info-table unit-table">
                    <tr class="unit-th">
                        ...
                        <th class="info-td th">Capacity</th>
                    ...
                    <tr>
                        ...
                        <td class="info-td td-l"><?php echo $v['capacity'];?>/20</td>
                        <td class="info-td td-m">
                            <?php if ($v["capacity"] < 20) {?>
                            <a class="edit-link" href="./updateAllocation.php?id=<?php echo $v['id'];?>&unitName=<?php echo $unitName;?>&capacity=<?php echo $v['capacity'];?>" onClick="return confirm('are you sure to join this session?')">join</a>
                            <?php }?>
                        </td>
                    </tr>
                    <?php }?>
